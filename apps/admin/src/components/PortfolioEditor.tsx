...
function cleanContent(value: Content): Content {
  return {
    ...
    experience: value.experience.map((item) => ({ ...item, highlights: cleanLines(item.highlights ?? []) })),
  };
}
